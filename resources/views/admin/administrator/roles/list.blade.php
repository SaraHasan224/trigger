...
@section('contents')
  ...
  <div class="content-viewport">
    ...
    {!! Form::open([ 'url' => route('role-delete'), 'id' => 'frm_list', 'method'=> 'delete']) !!}
    <div class="row">
          ...
          <div class="grid-header">
            ...
            <div class="actions">
              <div class="btn-group btn-group-sm" role="group" aria-label="...">
                <button type="button" class="btn btn-success has-icon" onclick="location.href='{{ route("role-add") }}'"><i class="mdi mdi-plus"></i>Add</button>
...
@section('javascripts')
  <script language="javascript">
      Globals["urlList"] = '{{ route("role-get-list") }}';
