...
@section('contents')
  ...
  <div class="content-viewport">
    ...
    {!! Form::open([ 'url' => route('city-update', ["id" => $Record->id])]) !!}
    <div class="row">
      <div class="col-lg-6 equel-grid">
        <div class="grid">
          <div class="grid-header">
            <div class="title">Edit City</div>
            <div class="actions">
          ...
          <div class="grid-body">
            <div class="item-wrapper">
              ...
              <div class="form-group">
                ...
                {!! Form::select('state_id', $country_name, old("state_id", $Record->state->name), ['class' => 'form-control my-select', 'id' => 'state_id']) !!}
              </div>
            </div>
          </div>
        </div>
