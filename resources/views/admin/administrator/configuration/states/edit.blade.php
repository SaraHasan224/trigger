...
@section('contents')
  ...
  <div class="content-viewport">
    ...
    {!! Form::open([ 'url' => route('state-update', ["id" => $Record->id])]) !!}
    <div class="row">
      <div class="col-lg-6 equel-grid">
        <div class="grid">
          <div class="grid-header">
            <div class="title">Edit State</div>
            <div class="actions">
          ...
          <div class="grid-body">
            <div class="item-wrapper">
              <div class="form-group">
                ...
                {!! Form::text('name', unescape($Record->name), ['id' => 'name', 'class' => 'form-control', 'maxlength' => '30']) !!}
              </div>
              <div class="form-group">
                <label for="Name">Country:</label>
                {!! Form::select('country_id', $country_name, old("country_id", $Record->country->name), ['class' => 'form-control my-select', 'id' => 'country_id']) !!}
              </div>
            </div>
          </div>
        </div>
