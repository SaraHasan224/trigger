...
@section('contents')
  ...
  <div class="content-viewport">
    ...
    {!! Form::open([ 'url' => route('countries-delete'), 'id' => 'frm_list', 'method' => 'DELETE']) !!}
    <div class="row">
          ...
          <div class="grid-header">
            ...
            <div class="actions">
              <div class="btn-group btn-group-sm" role="group" aria-label="...">
                <button type="button" class="btn btn-success has-icon" onclick="location.href='{{ route("countries-add") }}'"><i class="mdi mdi-plus"></i>Add</button>
...
@section('javascripts')
  <script language="javascript">
      Globals["urlList"] = '{{ route("countries-get-list") }}';
