...
@section('contents')
  ...
  <div class="content-viewport">
    ...
    {!! Form::open([ 'url' => route('countries-update', ["id" => $Record->id])]) !!}
    <div class="row">
          ...
          <div class="grid-body">
            <div class="item-wrapper">
              <div class="form-group">
                ...
                {!! Form::text('sort_name', unescape($Record->sortname), ['id' => 'sort_name', 'class' => 'form-control', 'maxlength' => '30']) !!}
              </div>
              <div class="form-group">
                <label for="Name">Name:</label>
                {!! Form::text('name', unescape($Record->name), ['id' => 'name', 'class' => 'form-control', 'maxlength' => '50']) !!}
              </div>
              <div class="form-group">
                <label for="PhoneCode">Phone Code:</label>
                {!! Form::text('phone_code', unescape($Record->phonecode), ['id' => 'phone_code', 'class' => 'form-control', 'maxlength' => '8']) !!}
              </div>
              <div class="form-group">
                <label for="LangCode">Language Code:</label>
                {!! Form::text('lang_code', unescape($Record->locale), ['id' => 'lang_code', 'class' => 'form-control', 'maxlength' => '11']) !!}
              </div>
            </div>
          </div>
        </div>
