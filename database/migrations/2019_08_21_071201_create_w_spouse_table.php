...
class CreateWSpouseTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('w_spouse', function (Blueprint $table) {
            ...
            $table->string('maiden_name',30)->nullable(true);
            $table->timestamps();
        });
    }
